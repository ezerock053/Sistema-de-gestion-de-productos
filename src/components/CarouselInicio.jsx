    ...
    <div id="carouselInicio" className="carousel slide" data-bs-ride="carousel">
      ...
      <div className="carousel-inner">
        <div className="carousel-item active">
          <img src="/productos/cargador-inalambrico.jpg" className="d-block w-100" alt="Producto 1" />
        </div>
        <div className="carousel-item">
          <img src="/productos/camara-seguridad.jpg" className="d-block w-100" alt="Producto 2" />
        </div>
        <div className="carousel-item">
          <img src="/productos/controlador-riego.jpg" className="d-block w-100" alt="Producto 3" />
        </div>
      </div>
